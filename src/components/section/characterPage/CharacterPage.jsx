...
const CharacterPage = () => {
    return (
        <div className='character-page'>
            <h2 className='left-title character-title'>About Character</h2>
            <h4 className='left-title character-batman'>the batman</h4>
            <p className='left-description charachter-description'>
